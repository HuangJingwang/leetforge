...
# Session validity cache: avoid hitting LeetCode API on every /api/data call.
...
def _check_session_cached() -> bool:
    """Return whether the current session is valid, with caching."""
    import time
...
def _invalidate_session_cache():
    """Force re-check on next /api/data call."""
...
def _build_comprehensive_data(
    ...
    return {
        ...
        "session_valid": _check_session_cached(),
    }
